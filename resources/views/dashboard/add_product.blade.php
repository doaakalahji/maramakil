            ...
            <div class="col-md-12">
                <div class="breadcrumb">
                    <ul>
                        ...
                        <li class="active">
                            <a href="{{route('product.create')}}">@lang('app.add_products')</a>
                        </li>
                        </ul>
                    </ul>
                </div>
                <h1 class="page-title">@lang('app.add_products')</h1>
            </div>
        </div>
    </div>
</section>
                           ...
                           @endif
                            ...
                            <div class="row col-md-12">
                                <div class="form-group col-md-6 col-lg-6 col-xs-6">
                                    <label for="f1">@lang('app.product_name_en')</label>
                                ...
                                <div class="form-group ol-md-6 col-lg-6 col-xs-6">
                                    <label for="textarea1">@lang('app.product_details_en')</label>
                                    <textarea
                                    class="text_field" name="description_en" id="textarea1">
                            ...
                            <div class="row col-md-12">
                                <div class="form-group col-md-6 col-lg-6 col-xs-6">
                                    <label for="f1">@lang('app.product_name_ar')</label>
                                    <input type="text" id="f1" class="text_field"
                                ...
                                <div class="form-group ol-md-6 col-lg-6 col-xs-6">
                                    <label for="textarea1">@lang('app.product_details_ar')</label>
                                    <textarea
                                    class="text_field" name="description_ar" id="textarea1">
                            ...
                            <div class="row col-md-12">
                                <div class="form-group col-md-6 col-lg-6 col-xs-6">
                                    <label for="f1">@lang('app.product_name_tr')</label>
                                    <input type="text" id="f1" class="text_field"
                                ...
                                <div class="form-group ol-md-6 col-lg-6 col-xs-6">
                                    <label for="textarea1">@lang('app.product_details_tr')</label>
                                    <textarea
                                    class="text_field" name="description_tr" id="textarea1">
                            ...
                            <div class="row col-md-12">
                            <div class="form-group col-md-6 col-lg-6 col-xs-6">
                                <label for="rlicense">@lang('app.price')</label>
                            ...
                            <div class="form-group col-md-6 col-lg-6 col-xs-6">
                                <label for="cv_upload">@lang('app.product_image')</label>
